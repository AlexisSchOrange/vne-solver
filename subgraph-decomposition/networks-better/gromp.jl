...
function solve_gromp(instance; nb_columns=200)
    ...
    sub_mappings = find_submappings(instance, vn_decompo, solver="mepso", nb_columns=nb_columns)
...
function find_submappings(instance, vn_decompo; solver="mepso", nb_columns=200)
