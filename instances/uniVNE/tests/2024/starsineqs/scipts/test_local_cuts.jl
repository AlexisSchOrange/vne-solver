...
function solve(instance, time_solver = 30)
    ...
    set_silent(model_lp)
    set_up_2delta!(instance, model_lp, nb_vnodes_cuts)
    ...
    parameters = set_up_2delta!(instance, model_ip, nb_vnodes_cuts)
    optimize!(model_ip)
...
function set_up_2delta!(instance, model, nb_vnodes)
